...
public class QItemOption extends EntityPathBase<ItemOption> {
    ...
    private static final long serialVersionUID = -1415207907L;
    ...
    public final com.rudkids.core.item.domain.itemOptionGroup.QItemOptionGroup itemOptionGroup;
    ...
    public QItemOption(Class<? extends ItemOption> type, PathMetadata metadata, PathInits inits) {
        ...
        this.itemOptionGroup = inits.isInitialized("itemOptionGroup") ? new com.rudkids.core.item.domain.itemOptionGroup.QItemOptionGroup(forProperty("itemOptionGroup"), inits.get("itemOptionGroup")) : null;
