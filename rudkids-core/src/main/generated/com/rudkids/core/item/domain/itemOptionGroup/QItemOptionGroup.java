...
public class QItemOptionGroup extends EntityPathBase<ItemOptionGroup> {
    ...
    private static final long serialVersionUID = -784453777L;
    ...
    public final ListPath<com.rudkids.core.item.domain.itemOption.ItemOption, com.rudkids.core.item.domain.itemOption.QItemOption> itemOptions = this.<com.rudkids.core.item.domain.itemOption.ItemOption, com.rudkids.core.item.domain.itemOption.QItemOption>createList("itemOptions", com.rudkids.core.item.domain.itemOption.ItemOption.class, com.rudkids.core.item.domain.itemOption.QItemOption.class, PathInits.DIRECT2);
