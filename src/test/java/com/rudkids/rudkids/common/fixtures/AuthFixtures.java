...
public class AuthFixtures {
    ...
    public static AuthRequest.Token MEMBER_토큰_요청() {
        return new AuthRequest.Token(MEMBER_인증_코드, REDIRECT_URI);
    }

    public static AuthResponse.AccessAndRefreshToken MEMBER_토큰_응답() {
        return new AuthResponse.AccessAndRefreshToken(에세스_토큰, 리프래쉬_토큰);
    }

    public static AuthRequest.RenewalToken MEMBER_에세스_토큰_재발급_요청() {
